 ...
 */
class Image extends \Gbrfix\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Image' . "\0" . 'ext', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Image' . "\0" . 'tempFilename'];
        }
    ...
    public function isImageValid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isImageValid', []);

        return parent::isImageValid();
    }
