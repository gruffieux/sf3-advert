 ...
 */
class Application extends \Gbrfix\PlatformBundle\Entity\Application implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'id', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'user', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'content', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'date', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'advert', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Application' . "\0" . 'documents'];
        }
