...
namespace Proxies\__CG__\Gbrfix\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Gbrfix\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Gbrfix\\UserBundle\\Entity\\User' . "\0" . 'adverts', '' . "\0" . 'Gbrfix\\UserBundle\\Entity\\User' . "\0" . 'applications', '' . "\0" . 'Gbrfix\\UserBundle\\Entity\\User' . "\0" . 'ip', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
