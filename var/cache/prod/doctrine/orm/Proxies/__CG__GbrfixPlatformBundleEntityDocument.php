 ...
 */
class Document extends \Gbrfix\PlatformBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'id', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'title', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'extension', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'mimetype', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'updatedAt', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'filename', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'application', '' . "\0" . 'Gbrfix\\PlatformBundle\\Entity\\Document' . "\0" . 'file'];
        }
